...
import { advanceToNextPlayableTurn, eliminatePlayer, finishMatchIfSinglePlayerRemaining } from "../resolvers/index.js";
import { getAvailableActions } from "./available-actions.js";
import { EngineRuleError } from "./errors.js";
function assertBoardMatchesState(input) {
...
function applyAbandonPlayerOutcome(input) {
...
export function applyEngineLifecycleOutcome(input) {
