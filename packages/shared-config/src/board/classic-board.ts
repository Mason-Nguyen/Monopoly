import type { BoardConfig, PropertyConfig, TileConfig } from "@monopoly/shared-types";
...
const CLASSIC_PROPERTIES: PropertyConfig[] = [
...
const CLASSIC_TILES: TileConfig[] = [
...
export const CLASSIC_BOARD_CONFIG: BoardConfig = assertValidBoardConfig({
...
export function getClassicTileConfig(tileIndex: number): TileConfig | undefined {
  return CLASSIC_TILE_CONFIG_BY_INDEX.get(tileIndex);
}

export function getClassicPropertyConfig(propertyId: string): PropertyConfig | undefined {
