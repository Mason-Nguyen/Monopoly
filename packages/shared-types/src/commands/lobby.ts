...
export const LOBBY_SET_READY_COMMAND = "lobby:setReady";
export const LOBBY_START_MATCH_COMMAND = "lobby:startMatch";

export type LobbyCommandName =
  | typeof LOBBY_SET_READY_COMMAND
  | typeof LOBBY_START_MATCH_COMMAND;
