...
export declare const LOBBY_ERROR_EVENT = "lobby:error";
export declare const LOBBY_MATCH_STARTING_EVENT = "lobby:matchStarting";
export declare const LOBBY_MATCH_START_FAILED_EVENT = "lobby:matchStartFailed";
export type LobbyEventName = typeof LOBBY_ERROR_EVENT | typeof LOBBY_MATCH_STARTING_EVENT | typeof LOBBY_MATCH_START_FAILED_EVENT;
